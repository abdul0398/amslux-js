...
io.on('connection', (socket) => {
  ...
  socket.on('join_conversation', (data) => chatController.joinConversation(socket, data));
  socket.on('send_message', (data) => chatController.sendMessage(io, socket, data));
  ...
  socket.on('load_more_messages', (data) => chatController.loadMoreMessages(socket, data));
  ...
  socket.on('respond_to_request', (data) => chatController.respondToChatRequest(io, socket, data));
